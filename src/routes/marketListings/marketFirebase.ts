...
export const buyOrderMap = async (listId: MarketListId): Promise<Map<string, OBOrder>> => {
...
export const sellOrderMap = async (listId: MarketListId): Promise<Map<string, OBOrder>> => {
